...
<gameSystem id="sys-352e-adc2-7639-d6a9" name="Warhammer 40,000 10th Edition" revision="9" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <profileTypes>
    ...
    <profileType id="74f8-5443-9d6d-1f1e" name="ESTRATAGEMA TRANSPORT">
      <characteristicTypes>
        <characteristicType id="30f2-be70-861d-1b84" name="Capacity"/>
      </characteristicTypes>
    </profileType>
    <profileType id="7e80-17f4-dd06-fd62" name="Estratagemas">
      <characteristicTypes>
        <characteristicType id="1606-37d3-fc5b-ecb2" name="Coste"/>
        <characteristicType id="46ab-ef4c-183d-8fb2" name="Cuando"/>
        <characteristicType id="b96c-f65f-065e-a8d4" name="Objetivo"/>
        <characteristicType id="b8bb-51a6-a478-af37" name="Efecto"/>
      </characteristicTypes>
    </profileType>
    <profileType id="c837-f4ad-a7b3-28a7" name="estratagemas">
      <characteristicTypes>
        <characteristicType id="02d7-7c72-9e99-0986" name="cp"/>
      </characteristicTypes>
    </profileType>
  </profileTypes>
  <categoryEntries>
